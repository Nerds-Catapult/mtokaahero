 ...
 */
export async function handleMissingArguments(args: Record<string, any>): Promise<ErrorResponse | null> {
 ...
 */
export async function handleEntityNotFound(entityName: string, id: string): Promise<ErrorResponse> {
    return {
        statusCode: 404,
 ...
 */
export async function handleInvalidData(message: string, details?: any): Promise<ErrorResponse> {
    return {
        statusCode: 400,
        message,
 ...
 */
export async function createErrorResponse(message: string, statusCode: number = 400, error?: any): Promise<ErrorResponse> {
    return {
        statusCode,
        message,
        error: error || message,

...
import { UserRole } from "@/lib/generated/prisma" // Assuming this path is correct
...
export default function SignUpPage() {
  ...
  const handleCompleteBusinessSetup = async () => {
    ...
    try {
      ...
      // Set the existing user data and move to business setup
    ...
    try {
      ...
      if (existingUser?.exists) {
        if (isBusinessAccount() && !existingUser.hasBusiness && existingUser.user.role !== UserRole.CUSTOMER) {
          // User exists, is a business account type, but doesn't have business setup
  ...
  const handleBusinessSubmit = async (e: React.FormEvent) => {
    ...
    try {
      let signInResult
      if (existingUserData) {
        // For existing users, we need them to sign in first
        ...
        // For new users, sign in with the password they just created
        signInResult = await signIn("credentials", {
          email: formData.email,
          password: formData.password,
          redirect: false,
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <div className={`mt-2 space-y-1 ${formData.password.length === 0 ? "hidden" : ""}`}>
                    <PasswordRequirement met={passwordFeedback.minLength}>At least 8 characters</PasswordRequirement>
                    ...
                    <PasswordRequirement met={passwordFeedback.hasNumber}>At least 1 number</PasswordRequirement>
                ...
                <Dialog open={showCompleteBusinessDialog} onOpenChange={setShowCompleteBusinessDialog}>
                  ...
                  <DialogContent>
                    <DialogHeader>
                      ...
                      <DialogDescription>
                        Enter your email or phone number to continue setting up your business profile.
                      </DialogDescription>
                    </DialogHeader>
        ...
        {step === 3 && (
          <Card>
            <CardHeader>
              <CardTitle>{existingUserData ? "Complete Your Business Setup" : "Business Details"}</CardTitle>
              <CardDescription>
                {existingUserData
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleBusinessInputChange("address.city", e.target.value)}
                        required
                        disabled={isLoading}
                        placeholder="City"
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleBusinessInputChange("address.state", e.target.value)}
                        required
                        disabled={isLoading}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleBusinessInputChange("address.zipCode", e.target.value)}
                        required
                        disabled={isLoading}
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) => handleBusinessInputChange("address.country", e.target.value)}
                        required
                        disabled={isLoading}
                        placeholder="Country"
                      />

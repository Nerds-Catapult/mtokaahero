...
export function EmergencyServiceModal({ open, onOpenChange, businessId }: EmergencyServiceModalProps) {
    ...
    const onSubmit = async (data: EmergencyServiceFormValues) => {
        if (!businessId) {
            toast.error('Business ID is required to request emergency service.');
            return;
        }
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Be as specific as possible about your location</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
                            ...
                            render={({ field }) => (
                                <FormItem className="flex flex-row items-start space-x-3 space-y-0 p-2 border rounded-md">
                                    ...
                                    <div className="space-y-1 leading-none">
                                        <FormLabel>
                                            I understand this service may incur additional charges and consent to being

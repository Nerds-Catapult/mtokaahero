...
import { FindNearbyServicesModal } from '@/components/modals/find-nearby-services-modal';
...
function CustomerQuickActions() {
    ...
    const [showNearbyServicesModal, setShowNearbyServicesModal] = useState(false);
    ...
    return (
        <Card>
            ...
            <CardContent className="space-y-3">
                <Button className="w-full justify-start" variant="outline" onClick={() => setShowScheduleModal(true)}>
                    <Calendar className="mr-2 h-4 w-4" />
                    Book New Service
                </Button>
                <Button className="w-full justify-start" variant="outline" onClick={() => setShowAddVehicleModal(true)}>
                ...
                <Button className="w-full justify-start" variant="outline" onClick={() => setShowReviewModal(true)}>
            ...
            <ScheduleServiceModal
                ...
                businessId="default-business-id" // In a real app, this would be selected by the user
            />

            <AddVehicleModal open={showAddVehicleModal} onOpenChange={setShowAddVehicleModal} userId={userId} />

            <FindNearbyServicesModal open={showNearbyServicesModal} onOpenChange={setShowNearbyServicesModal} />

            <LeaveReviewModal open={showReviewModal} onOpenChange={setShowReviewModal} userId={userId} />
        </Card>
    );
}
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid lg:grid-cols-2 gap-6 mb-8">
                <ChartSection title="Service Spending" description="Monthly spending on vehicle services">
